...
digraph {
    ...
    Id [label="peer_parachain::primitives::Id"]
    CollatorId [label="peer_primitives::v2::CollatorId"]
    ...
    CandidateCommitments:upward_messages -> "peer_parachain::primitives::UpwardMessage":w
    ...
    CandidateCommitments:horizontal_messages -> "peer_parachain::primitives::Id":w
    CandidateCommitments:new_validation_code -> "peer_parachain::primitives::ValidationCode":w
    ...
    PoV:block_data -> "peer_parachain::primitives::BlockData":w
    ...
    BackedCandidate:validity_votes  -> "peer_primitives:v0:ValidityAttestation":w

    HeadData [label = "peer_parachain::primitives::HeadData"]
    ...
    ValidatorId [label = "peer_primitives::v2::ValidatorId"]
    AuthorityDiscoveryId [label = "sp_authority_discovery::AuthorityId"]
    ValidatorIndex [label = "peer_primitives::v2::ValidatorIndex"]
