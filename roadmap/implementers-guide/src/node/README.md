...
We assume the following constraints regarding provided basic functionality:
  ...
  * There is an underlying **networking** framework which provides **vine discovery** services which will provide us with peers and will not create "loopback" connections to our own node. The number of peers we will have is assumed to be bounded at 1000.
