...
use vine_core_primitives::BlockNumber as RelayBlockNumber;
use peer_parachain::primitives::{
...
parameter_types! {
	pub const Location: MultiLocation = MultiLocation::parent();
	pub const RelayNetwork: NetworkId = NetworkId::Anyl
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		peerXcm: pallet_xcm::{Pallet, Call, Event<T>, Origin},
	}
);
