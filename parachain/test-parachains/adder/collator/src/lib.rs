...
use vine_primitives::v2::{CollatorId, CollatorPair};
...
impl Collator {
	...
	pub fn create_collation_function(
		...
		Box::new(move |relay_parent, validation_data| {
			...
			let compressed_pov = vine_node_primitives::maybe_compress_pov(pov);
...
mod tests {
	...
	use vine_primitives::v2::PersistedValidationData;
