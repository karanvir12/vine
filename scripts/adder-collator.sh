...
# disabled until we can actually successfully register the chain with peer-js-api
# if ! command -v peer-js-api > /dev/null; then
#   echo "peer-js-api required; try"
#   echo "  sudo yarn global add @peer/api-cli"
#   exit 1
# fi
...
# doesn't work yet due to https://github.com/peer-js/tools/issues/185
# peer-js-api \
