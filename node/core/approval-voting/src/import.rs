...
pub(crate) mod tests {
	...
	use vine_node_primitives::approval::{VRFOutput, VRFProof};
	use vine_node_subsystem::messages::{AllMessages, ApprovalVotingMessage};
	...
	impl AssignmentCriteria for MockAssignmentCriteria {
		...
		fn check_assignment_cert(
			...
			_validator_index: vine_primitives::v2::ValidatorIndex,
			_config: &criteria::Config,
			_relay_vrf_story: vine_node_primitives::approval::RelayVRFStory,
