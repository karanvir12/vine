...
use bitvec::bitvec;
use vine_primitives::v2::{OccupiedCore, ScheduledCore};
...
mod select_availability_bitfields {
	...
	use vine_primitives::v2::{ScheduledCore, SigningContext, ValidatorId, ValidatorIndex};
...
pub(crate) mod common {
	...
	pub fn test_harness<OverseerFactory, Overseer, TestFactory, Test>(
		...
		Test: Future<Output = ()>,
	{
		let (tx, rx) = vine_node_subsystem_test_helpers::sender_receiver();
