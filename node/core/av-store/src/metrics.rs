		...
		let metrics = MetricsInner {
			received_availability_chunks_total: prometheus::register(
				prometheus::Counter::new(
					"peer_parachain_received_availability_chunks_total",
			...
			pruning: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"peer_parachain_av_store_pruning",
			...
			process_block_finalized: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"peer_parachain_av_store_process_block_finalized",
			...
			block_activated: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"peer_parachain_av_store_block_activated",
			...
			process_message: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"peer_parachain_av_store_process_message",
			...
			store_available_data: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"peer_parachain_av_store_store_available_data",
			...
			store_chunk: prometheus::register(
				prometheus::Histogram::with_opts(prometheus::HistogramOpts::new(
					"peer_parachain_av_store_store_chunk",
			...
			get_chunk: prometheus::register(
				prometheus::Histogram::with_opts(
					prometheus::HistogramOpts::new(
						"peer_parachain_av_store_get_chunk",
