...
use {
	peer_node_subsystem_util::database::Database, std::io, std::path::PathBuf, std::sync::Arc,
};
...
pub fn open_creating_rocksdb(
	...
	let db = peer_node_subsystem_util::database::kvdb_impl::DbAdapter::new(
		db,
...
pub fn open_creating_paritydb(
	...
	let db = peer_node_subsystem_util::database::paritydb_impl::DbAdapter::new(
		db,
		columns::v2::ORDERED_COL,
	);
	Ok(Arc::new(db))
