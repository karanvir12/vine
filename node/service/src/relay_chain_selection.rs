...
use peer_node_primitives::MAX_FINALITY_LAG as PRIMITIVES_MAX_FINALITY_LAG;
...
const MAX_FINALITY_LAG: peer_primitives::v2::BlockNumber = PRIMITIVES_MAX_FINALITY_LAG;
