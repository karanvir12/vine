...
use vine_node_network_protocol::{self as net_protocol, OurView};
use vine_node_subsystem::{messages::NetworkBridgeEvent, ActivatedLeaf};
...
fn new_test_network(
	...
	let (net_tx, net_rx) = vine_node_subsystem_test_helpers::single_item_sink();
