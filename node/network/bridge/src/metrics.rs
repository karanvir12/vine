		...
		let metrics = MetricsInner {
			...
			connected_events: prometheus::register(
				prometheus::CounterVec::new(
					prometheus::Opts::new(
						"peer_parachain_peer_connect_events_total",
			...
			disconnected_events: prometheus::register(
				prometheus::CounterVec::new(
					prometheus::Opts::new(
						"peer_parachain_peer_disconnect_events_total",
			...
			desired_peer_count: prometheus::register(
				prometheus::GaugeVec::new(
					prometheus::Opts::new(
						"peer_parachain_desired_peer_count",
			...
			report_events: prometheus::register(
				prometheus::Counter::new(
					"peer_parachain_network_report_events_total",
			...
			notifications_received: prometheus::register(
				prometheus::CounterVec::new(
					prometheus::Opts::new(
						"peer_parachain_notifications_received_total",
			...
			notifications_sent: prometheus::register(
				prometheus::CounterVec::new(
					prometheus::Opts::new(
						"peer_parachain_notifications_sent_total",
			...
			bytes_received: prometheus::register(
				prometheus::CounterVec::new(
					prometheus::Opts::new(
						"peer_parachain_notification_bytes_received_total",
			...
			bytes_sent: prometheus::register(
				prometheus::CounterVec::new(
					prometheus::Opts::new(
						"peer_parachain_notification_bytes_sent_total",
