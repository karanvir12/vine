...
use vine_node_network_protocol::request_response::v1::DisputeRequest;
use vine_node_primitives::{CandidateVotes, DisputeMessage, SignedDisputeStatement};
use vine_node_subsystem::{messages::DisputeCoordinatorMessage, overseer, ActiveLeavesUpdate};
use vine_node_subsystem_util::runtime::RuntimeInfo;
use vine_primitives::v2::{CandidateHash, DisputeStatement, Hash, SessionIndex};
...
impl DisputeSender {
	...
	async fn start_send_for_dispute<Context>(
		...
		// Related to <https://github.com/paritytech/peer/issues/4730> .
		let ref_head = self
			.active_sessions
			.iter()
