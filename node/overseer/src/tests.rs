...
fn extract_metrics(registry: &prometheus::Registry) -> HashMap<&'static str, u64> {
	...
	let activated = extract("peer_parachain_activated_heads_total");
	let deactivated = extract("peer_parachain_deactivated_heads_total");
	let relayed = extract("peer_parachain_messages_relayed_total");
