...
use vine_runtime_parachains::reward_points::RewardValidatorsWithEraPoints;
use primitives::v2::{
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("vine-test-runtime"),
	impl_name: create_runtime_str!("parity-vine-test-runtime"),
	authoring_version: 2,
	spec_version: 1056,
	impl_version: 0,
