...
//! The vine runtime. This can be compiled with `#[no_std]`, ready for Wasm.
...
use runtime_common::{
	...
	prod_or_fast, slots, BlockHashCount, BlockLength, CurrencyToVote, SlowAdjustingFeeUpdate,assigned_slots
};
...
use frame_support::{
	...
	traits::{
		...
		// PrivilegeCmp, WithdrawReasons,FindAuthor,OnUnbalanced,Currency
				...
				fungible::ItemOf, AsEnsureOriginWithArg, ConstBool, ConstU128, ConstU16, ConstU32,
					...
					WithdrawReasons,FindAuthor, PrivilegeCmp
	},
...
use sp_runtime::{
	...
	traits::{
		AccountIdLookup, BlakeTwo256, Block as BlockT, ConvertInto, Extrinsic as ExtrinsicT,DispatchInfoOf,
		Convert,OpaqueKeys, SaturatedConversion, Verify,PostDispatchInfoOf,
	},
...
use vine_runtime_constants::{currency::*, fee::*, time::*};
...
impl_runtime_weights!(vine_runtime_constants);

// Make the WASM binary available.
#[cfg(feature = "std")]
include!(concat!(env!("OUT_DIR"), "/wasm_binary.rs"));

// vine version identifier;
/// Runtime version (vine).
...
parameter_types! {
	...
	// Each good submission will get 1 vine as reward
...
pub struct DealWithFees2;
impl OnUnbalanced<NegativeImbalance> for DealWithFees2 {
...
impl pallet_evm::Config for Runtime {
	...
	type OnChargeTransaction = pallet_evm::EVMCurrencyAdapter<Balances, DealWithFees2>;
...
parameter_types! {
	...
	pub const MaxSignatories: u32 = 101;
}
...
parameter_types! {
	...
	// vine Genesis was on May 26, 2020.
...
parameter_types! {
	pub const PermanentSlotLeasePeriodLength: u32 = 8;
	pub const TemporarySlotLeasePeriodLength: u32 = 1;
	pub const MaxPermanentSlots: u32 = 1;
	pub const MaxTemporarySlots: u32 = 1;
	pub const MaxTemporarySlotPerLeasePeriod: u32 = 1;
}
...
parameter_types! {
	...
	pub const EndingPeriod: BlockNumber = 2 * MINUTES;
...
impl frame_support::traits::OnRuntimeUpgrade for InitiateNominationPools {
	fn on_runtime_upgrade() -> frame_support::weights::Weight {
		...
		if pallet_nomination_pools::MaxPools::<Runtime>::get().is_none() {
			...
			log::info!(target: "runtime::vine", "pools config initiated 🎉");
			<Runtime as frame_system::Config>::DbWeight::get().reads_writes(1, 5)
		} else {
			log::info!(target: "runtime::vine", "pools config already initiated 😏");
...
construct_runtime! {
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		//contracts added
		Contracts: pallet_contracts::{Pallet, Call, Storage, Event<T>} = 22,
		...
		XcmPallet: pallet_xcm::{Pallet, Call, Storage, Event<T>, Origin, Config} = 99,
		 ...
		 BaseFee: pallet_base_fee::{Pallet, Call, Storage, Event, Config<T>} ,
		 HotfixSufficients: pallet_hotfix_sufficients::{Pallet, Call, Storage} ,
...
sp_api::impl_runtime_apis! {
	...
	impl frame_try_runtime::TryRuntime<Block> for Runtime {
		fn on_runtime_upgrade(checks: bool) -> (Weight, Weight) {
			log::info!("try-runtime::on_runtime_upgrade vine.");
...
mod remote_tests {
	...
	async fn run_migrations() {
		...
		let transport: Transport =
			var("WS").unwrap_or("wss://rpc.vine.io:443".to_string()).into();
