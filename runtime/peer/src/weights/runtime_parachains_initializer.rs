...
// --output=./runtime/peer/src/weights/runtime_parachains_initializer.rs
...
impl<T: frame_system::Config> runtime_parachains::initializer::WeightInfo for WeightInfo<T> {
	...
	fn force_approve(d: u32, ) -> Weight {
		// Minimum execution time: 8_317 nanoseconds.
		Weight::from_ref_time(11_009_964)
			// Standard Error: 5
			.saturating_add(Weight::from_ref_time(1_314).saturating_mul(d.into()))
