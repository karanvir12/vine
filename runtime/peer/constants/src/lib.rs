...
pub mod time {
	...
	pub const EPOCH_DURATION_IN_SLOTS: BlockNumber = prod_or_fast!(30 * MINUTES, 30 * MINUTES);
	...
	// <https://research.web3.foundation/en/latest/peer/BABE/Babe/#6-practical-results>
...
pub mod fee {
	...
	impl WeightToFeePolynomial for WeightToFee {
		...
		fn polynomial() -> WeightToFeeCoefficients<Self::Balance> {
			// in peer, extrinsic base weight (smallest non-zero weight) is mapped to 1/10 CENT:
