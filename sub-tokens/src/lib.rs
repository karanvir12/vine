...
//!
//! ## Default Tokens: `vine`, 
//! Current crate provides implementations for vine. note that vnes are 10 decimal
...
//! let vnes = vine::from(1_000_000_000_000u128);
//!
//! // provides display and format implementations.
//! assert_eq!(format!("{}", vnes), "100,000 vine");
//! assert_eq!(format!("{:?}", vnes), "100,000 vine (1,000,000,000,000)");
//! ```
//!
//! ## Custom tokens
//!
